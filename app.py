...
if missing:
    st.warning(f"No usable data for: {', '.join(missing)}. Continuing with the rest.")
...
with col2:
    ...
    fig_pie = go.Figure(go.Pie(labels=weights_df["Ticker"], values=weights_df["Weight %"], hole=0.45))
